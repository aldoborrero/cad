...
The usual trio, all sharing the project's name: `espmmwave-v0.2.0.kicad_pro`,
...
```sh
kicad-cli pcb drc --severity-all -o /tmp/drc.rpt espmmwave-v0.2.0.kicad_pcb
```

## Handoff to the mechanical side

```sh
cad export espmmwave-v0.2.0     # -> exports/espmmwave-v0.2.0.step
cad render espmmwave-v0.2.0 iso # -> exports/espmmwave-v0.2.0-iso.png
```
