...
```sh
cad render espmmwave-v0.1.0 [iso|top|bottom|front|back|left|right]   # raytraced PNG
cad export espmmwave-v0.1.0     # STEP, for the mechanical side
cad gui    espmmwave-v0.1.0     # open the project in KiCad
```
...
`esphome/espmmwave-v0.1.0.yaml`, adapted from upstream's `yaml/example.yaml`. Copy
